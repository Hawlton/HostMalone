...
def configure_venv():
    os.mkdir("/home/hawlton/python_venv")
    os.system("python -m venv /home/hawlton/python_venv")
    with open("/home/hawlton/.zshrc", 'a') as zshrc:
        zshrc.write('\n')
        zshrc.write("source /home/hawlton/pyhton_venv/bin/activate")
...
def configure_zshrc():
    print('editing zshrc')
    with open(f'/home/hawlton/.zshrc', 'a+') as zshconf:
        zshconf.write(aliases)
        if socket.gethostname() == 'hawlton-braypad':
            zshconf.seek(0)
